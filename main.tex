...
To my classmates in the Astro major: Arianna, Bo, Sam, Katelyn, Thomas, Maggie, Sandy, Nabeel, and Tamar: I'm so glad we got to work and learn together. It has been a great privilege.
...
And finally to my parents, for their generous support in all endeavors. I promise not to dump yogurt on anyone else.
}
\dedication{}
\date{January 9, 2018}
\begin{document}
